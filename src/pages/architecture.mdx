...
- account[0] - RW - The VoteState. VoteState::lockouts and VoteState::credits are updated according to voting lockout rules see [Tower BFT](https://docs.velas.com/implemented-proposals/tower-bft.md).
