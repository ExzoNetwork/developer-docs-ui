...
export const sections = [
  ...
  { title: 'Exzo Network Test Validator', id: 'exzo_network_test' },
]

# Developing on native Exzo {{className: 'border-b border-zinc-900/5 dark:border-white/5 xl:max-w-none pb-5 mb-7'}}
...
Exzo Network nodes accept HTTP requests using the [JSON-RPC 2.0](https://www.jsonrpc.org/specification) specification.

To interact with a Exzo Network node inside a JavaScript application, use the [solana-web3.js](https://github.com/solana-labs/solana-web3.js) library, which gives a convenient interface for the RPC methods.
...
- [getAccountInfo](https://docs.velas.com/apps/jsonrpc-api#getaccountinfo)
- [getBalance](https://docs.velas.com/apps/jsonrpc-api#getbalance)
- [getBlockCommitment](https://docs.velas.com/apps/jsonrpc-api#getblockcommitment)
- [getBlockTime](https://docs.velas.com/apps/jsonrpc-api#getblocktime)
- [getClusterNodes](https://docs.velas.com/apps/jsonrpc-api#getclusternodes)
- [getConfirmedBlock](https://docs.velas.com/apps/jsonrpc-api#getconfirmedblock)
- [getConfirmedBlocks](https://docs.velas.com/apps/jsonrpc-api#getconfirmedblocks)
- [getConfirmedBlocksWithLimit](https://docs.velas.com/apps/jsonrpc-api#getconfirmedblockswithlimit)
- [getConfirmedSignaturesForAddress](https://docs.velas.com/apps/jsonrpc-api#getconfirmedsignaturesforaddress)
- [getConfirmedSignaturesForAddress2](https://docs.velas.com/apps/jsonrpc-api#getconfirmedsignaturesforaddress2)
- [getConfirmedTransaction](https://docs.velas.com/apps/jsonrpc-api#getconfirmedtransaction)
- [getEpochInfo](https://docs.velas.com/apps/jsonrpc-api#getepochinfo)
- [getEpochSchedule](https://docs.velas.com/apps/jsonrpc-api#getepochschedule)
- [getFeeCalculatorForBlockhash](https://docs.velas.com/apps/jsonrpc-api#getfeecalculatorforblockhash)
- [getFeeRateGovernor](https://docs.velas.com/apps/jsonrpc-api#getfeerategovernor)
- [getFees](https://docs.velas.com/apps/jsonrpc-api#getfees)
- [getFirstAvailableBlock](https://docs.velas.com/apps/jsonrpc-api#getfirstavailableblock)
- [getGenesisHash](https://docs.velas.com/apps/jsonrpc-api#getgenesishash)
- [getHealth](https://docs.velas.com/apps/jsonrpc-api#gethealth)
- [getIdentity](https://docs.velas.com/apps/jsonrpc-api#getidentity)
- [getInflationGovernor](https://docs.velas.com/apps/jsonrpc-api#getinflationgovernor)
- [getInflationRate](https://docs.velas.com/apps/jsonrpc-api#getinflationrate)
- [getInflationReward](https://docs.velas.com/apps/jsonrpc-api#getinflationReward)
- [getLargestAccounts](https://docs.velas.com/apps/jsonrpc-api#getlargestaccounts)
- [getLeaderSchedule](https://docs.velas.com/apps/jsonrpc-api#getleaderschedule)
- [getMaxRetransmitSlot](https://docs.velas.com/apps/jsonrpc-api#getmaxretransmitSlot)
- [getMaxShredInsertSlot](https://docs.velas.com/apps/jsonrpc-api#getmaxshredinsertSlot)
- [getMinimumBalanceForRentExemption](https://docs.velas.com/apps/jsonrpc-api#getminimumbalanceforrentexemption)
- [getMultipleAccounts](https://docs.velas.com/apps/jsonrpc-api#getmultipleaccounts)
- [getProgramAccounts](https://docs.velas.com/apps/jsonrpc-api#getprogramaccounts)
- [getRecentBlockhash](https://docs.velas.com/apps/jsonrpc-api#getrecentblockhash)
- [getRecentPerformanceSamples](https://docs.velas.com/apps/jsonrpc-api#getrecentperformancesamples)
- [getSnapshotSlot](https://docs.velas.com/apps/jsonrpc-api#getsnapshotslot)
- [getSignatureStatuses](https://docs.velas.com/apps/jsonrpc-api#getsignaturestatuses)
- [getSlot](https://docs.velas.com/apps/jsonrpc-api#getslot)
- [getSlotLeader](https://docs.velas.com/apps/jsonrpc-api#getslotleader)
- [getSlotLeaders](https://docs.velas.com/apps/jsonrpc-api#getslotleaders)
- [getStakeActivation](https://docs.velas.com/apps/jsonrpc-api#getstakeactivation)
- [getSupply](https://docs.velas.com/apps/jsonrpc-api#getsupply)
- [getTokenAccountBalance](https://docs.velas.com/apps/jsonrpc-api#gettokenaccountbalance)
- [getTokenAccountsByDelegate](https://docs.velas.com/apps/jsonrpc-api#gettokenaccountsbydelegate)
- [getTokenAccountsByOwner](https://docs.velas.com/apps/jsonrpc-api#gettokenaccountsbyowner)
- [getTokenLargestAccounts](https://docs.velas.com/apps/jsonrpc-api#gettokenlargestaccounts)
- [getTokenSupply](https://docs.velas.com/apps/jsonrpc-api#gettokensupply)
- [getTransactionCount](https://docs.velas.com/apps/jsonrpc-api#gettransactioncount)
- [getVersion](https://docs.velas.com/apps/jsonrpc-api#getversion)
- [getVoteAccounts](https://docs.velas.com/apps/jsonrpc-api#getvoteaccounts)
- [minimumLedgerSlot](https://docs.velas.com/apps/jsonrpc-api#minimumledgerslot)
- [requestAirdrop](https://docs.velas.com/apps/jsonrpc-api#requestairdrop)
- [sendTransaction](https://docs.velas.com/apps/jsonrpc-api#sendtransaction)
- [simulateTransaction](https://docs.velas.com/apps/jsonrpc-api#simulatetransaction)
- [Subscription Websocket](https://docs.velas.com/apps/jsonrpc-api#subscription-websocket)
  - [accountSubscribe](https://docs.velas.com/apps/jsonrpc-api#accountsubscribe)
  - [accountUnsubscribe](https://docs.velas.com/apps/jsonrpc-api#accountunsubscribe)
  - [logsSubscribe](https://docs.velas.com/apps/jsonrpc-api#logssubscribe)
  - [logsUnsubscribe](https://docs.velas.com/apps/jsonrpc-api#logsunsubscribe)
  - [programSubscribe](https://docs.velas.com/apps/jsonrpc-api#programsubscribe)
  - [programUnsubscribe](https://docs.velas.com/apps/jsonrpc-api#programunsubscribe)
  - [signatureSubscribe](https://docs.velas.com/apps/jsonrpc-api#signaturesubscribe)
  - [signatureUnsubscribe](https://docs.velas.com/apps/jsonrpc-api#signatureunsubscribe)
  - [slotSubscribe](https://docs.velas.com/apps/jsonrpc-api#slotsubscribe)
  - [slotUnsubscribe](https://docs.velas.com/apps/jsonrpc-api#slotunsubscribe)
...
- `<object>` - (optional) Configuration object containing the following optional fields:
  - (optional) [Commitment](https://docs.velas.com/apps/jsonrpc-api#configuring-state-commitment)
...
- `<string>` - Pubkey of account to query, as base-58 encoded string
- `<object>` - (optional) [Commitment](https://docs.velas.com/apps/jsonrpc-api#configuring-state-commitment)
...
- `<object>` - if block is confirmed, an object with the following fields:
  ...
  - `transactions: <array>` - an array of JSON objects containing:
    - `transaction: <object|[string,encoding]>` - [Transaction](https://docs.velas.com/apps/jsonrpc-api#transaction-structure) object, either in JSON format or encoded binary data, depending on encoding parameter
...
Transactions are quite different from those on other blockchains. Be sure to review [Anatomy of a Transaction](https://docs.velas.com/transaction) to learn about transactions on Exzo Network.
...
- (optional) [Commitment](https://docs.velas.com/apps/jsonrpc-api#configuring-state-commitment); "processed" is not supported. If parameter not provided, the default is "finalized".
...
- `<object>` - (optional) Configuration object containing the following optional fields:
  ...
  - (optional) `dataSlice: <object>` - limit the returned account data using the provided `offset: <usize>` and `length: <usize>` fields; only available for "base58" or "base64" encoding.
  - (optional) `filters: <array>` - filter results using various [filter objects](https://docs.velas.com/apps/jsonrpc-api#filters); account must meet all filter criteria to be included in results
...
- `<object>` - (optional) [Commitment](https://docs.velas.com/apps/jsonrpc-api#configuring-state-commitment) (used for retrieving blockhash and verifying airdrop success)
...
- `<object>` - (optional) Configuration object containing the following field:
  ...
  - `preflightCommitment: <string>` - (optional) [Commitment](https://docs.velas.com/apps/jsonrpc-api#configuring-state-commitment) level to use for preflight (default: `"max"`).
...
- `<object>` - (optional) Configuration object containing the following field:
  ...
  - `commitment: <string>` - (optional) [Commitment](https://docs.velas.com/apps/jsonrpc-api#configuring-state-commitment) level to simulate the transaction at (default: `"max"`).
...
- Many subscriptions take the optional [commitment parameter](https://docs.velas.com/apps/jsonrpc-api#configuring-state-commitment), defining how finalized a change should be to trigger a notification. For subscriptions, if commitment is unspecified, the default value is `"single"`.
...
This is the Exzo Network Javascript API built on [JSON RPC API](https://docs.velas.com/apps/javascript-api)
...
<script src="https://unpkg.com/@exzonetwork/web3.js@0.92.0/lib/index.iife.js"></script>

<!-- Production (un-minified) -->
<script src="https://unpkg.com/@exzonetwork/web3.js@0.92.0/lib/index.iife.min.js"></script>
```
...
```bash {{ title: 'ES6' }}
import exzonetworkWeb3 from '@exzonetwork/web3.js';
```
...
<!-- Production (un-minified) -->
// `exzonetworkWeb3` is provided in the global namespace by the `exzonetworkWeb3.min.js` script bundle.
```
...
A [Flow library definition](https://flow.org/en/docs/libdefs/) is provided at https://unpkg.com/@solana/web3.js@latest/module.flow.js. Download the file and add the following line under the [libs] section of your project’s `.flowconfig` to activate it: {{className: 'break-words'}}
...
The Exzo Network Program Library math tests will report the performance of some math operations: https://github.com/exzonetwork/exzonetwork-program-library/tree/master/libraries/math {{className: 'break-words'}}
...
- Install the latest Exzo Network command-line tools from https://docs.exzonetwork.com/cli/install-exzon-etwork-cli-tools {{className: 'break-words'}}
...
Rust's `println!` macro is computationally expensive and not supported. Instead the helper macro [msg!](https://github.com/velas/velas-chain/blob/v0.3.6/sdk/program/src/log.rs#L33) is provided.
...
https://github.com/exzonetwork/exzonetwork-chain/blob/v0.3.6/sdk/program/src/program_pack.rs {{className: 'break-words'}}
...
<GuidesOther
  id="exzo_network_test"
  title="Exzo Network Test Validator"
  level={2}
  isShow={false}
/>
