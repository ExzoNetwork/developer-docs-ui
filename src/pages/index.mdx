...
import logoExzotech from '@/images/exzo_tech.png'

export const sections = [
  { title: 'What is the Exzo Network?', id: 'what' },
...
export const elements = [
  {
    ...
    name: 'Exzo Network Block Explorer - Mainnet',
    description: '',
    icon: logoExzoscan,
    pattern: {
      y: 16,
  ...
  {
    href: 'https://testnet.exxzoscan.io',
    name: 'Exzo Network Block Explorer - Testnet',
    description: '',
    icon: logoExzoscan,
    pattern: {
      y: 16,
  ...
  {
    href: 'https://dex.exzo.technology',
...
export const guides = [
  ...
  },
  {
    ...
    name: 'Wallets',
    description:
      'Learn the different wallet options that are available to users of the Exzo Network.',
  },
  {
    href: '/staking',
    name: 'Staking',
  ...
  },
  {
    ...
    name: 'Developing on native Exzo',
    description:
  ...
  },
  {
    ...
    name: 'Integrating',
    description:
      'Learn how to add Exzo Network native token XZO to your cryptocurrency exchange.',
  },
  {
    href: '/validating',
    name: 'Validating',
    description: 'Learn how run a Exzo Network validator node.',
  },
  {
    href: '/clusters',
    name: 'Clusters',
    description:
      'Learn how Exzo Network maintains several different clusters with different purposes.',
  },
  {
    href: '/architecture',
    name: 'Architecture',
  ...
  },
  {
    ...
    name: 'Software',
    description:
      'Learn how Exzo Network project will be aimed to including full support of Ethereum based dApps.',
  },
  {
...
Exzo Network is a lightning-fast Layer-1 blockchain enabling users and developers to build EVM compatible decentralized apps, games, DeFi protocol's, and scaling solutions. {{ className: 'lead' }}

<GuidesOther
  id="what"
  title="What is the Exzo Network?"
  level={2}
  isShow={false}
/>

Exzo Network is a web3 infrastructure protocol with the mission of being the go to
...
and other features. Exzo Network also has multiple target markets including Decentralized
